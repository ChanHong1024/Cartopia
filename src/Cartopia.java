		...
		logout: while (true) {
			...
			if (cmd == 'l') {
				...
				if (Account.login(username, password)) {
					currentUser = Account.getAccountByUsername(username);
					...
					menu: while (true) {
						...
						case 's':
							...
							case 'o':
								...
								CustomerAccount renter = (CustomerAccount)currentUser;
								Date startDate = null;
								while (true) {
								...
								if(cmd == 'y'){
									...
									coupon: while(true){
										...
										switch(cmd){
											case '0': 
												Vector<AccountCoupon> ac = AccountCoupon.getAccountCoupons(currentUser);
						...
						case 'c':
							...
							Vector<Car> c = Car.getCarByAccount(currentUser);
							...
							case 'l':
								...
								new Car(currentUser, buildCarType, buildCarName, pricePerDay);
								break;
							case 'd':
